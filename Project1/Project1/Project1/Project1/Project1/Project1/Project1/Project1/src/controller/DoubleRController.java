...
public class DoubleRController {
   ...
   public Command rental() {
       ...
       System.out.println("=================================");
       System.out.println("책 코드\t제목\t출판사\t재고량");
       System.out.println("=================================");
       for (BookVo rentbook : bookRentalList) {
           System.out.println(rentbook.getBook_id() + "\t" + rentbook.getBook_name() + "\t" + rentbook.getBook_pub() + "\t" + rentbook.getBook_stock());
...
//========================================================================      
   ...
   public Command breturn() {
       ...
       System.out.println("=================================");
       System.out.println("책 코드\t대여 코드\t대여 날짜\t회원 ID");
       System.out.println("=================================");

       for (RentalVo breturnbook : bookRentalList) {
           System.out.println(breturnbook.getBook_id() + "\t"  + breturnbook.getRental_id() + "\t" + breturnbook.getRental_date() + "\t" + breturnbook.getMem_id());
