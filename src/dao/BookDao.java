...
//===================================================================================      
	...
	public List<BookVo> getSBookList() { // 과학
		...
		String sql = "SELECT BOOK_ID, BOOK_NAME, BOOK_PUB " + " FROM BOOK " + " WHERE BOOK_ID LIKE 's%%' "
...
//====================================================================================
    ...
    // BREGISTER 테이블에서 회원 삭제
    public int deleteBRegister(String memberId) {
        Connection con = null;
        PreparedStatement ps = null;
        int result = 0;
        ...
        try {
            con = DBUtil.getConnection();
            String sql = "DELETE FROM BREGISTER WHERE BREG_ID = ?";
            ps = con.prepareStatement(sql);
            ps.setString(1, memberId);
            result = ps.executeUpdate();
